...
const sortElements = item => {
  item.addEventListener('click', () => {
    ...
    !icon.classList.contains('checking__svg--rotate' && !icon.classList.contains('checking__svg--dnone')) ? forOf(icon.classList.add('checking__svg--rotate')) : console.log('not done');
  });
};
